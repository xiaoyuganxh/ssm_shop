            ...
            <div>
                    ...
                    <td>
                        <c:if test="${user.pic !=null}">
                            <img src="${pageContext.request.contextPath }/pic/${user.pic}" width=100 height=100/>
                            <br/>
                        </c:if>
                        <%--<input type="file"  name="pictureFile"/>--%>
                        <input href="/SMBMS/upload.html" type="button" onclick="ch()">
                    </td>
            </div>
...
<script>
    var ch=function () {
        location.href="/SMBMS/upload.html"
    }
</script>
