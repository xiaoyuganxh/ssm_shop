    ...
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            <p><span>下午好！</span><span style="color: #fff21b">
                <c:if test="${userSession.pic!='' and userSession.pic!=null}">
                    <img src="${pageContext.request.contextPath }/pic/${userSession.pic}" style="width:35px; height:35px; border-radius:50%"/>
                </c:if>
     ...
     <div class="left">
         ...
         <nav>
             <ul class="list">
              ...
              <li><a href="${pageContext.request.contextPath }/user.do.queryuser">用户管理</a></li>
